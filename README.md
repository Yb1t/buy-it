...
### 界面设计
#### 消息列表
![消息列表](readme-img/消息列表.jpg =0.5x)
#### 聊天对话
![聊天界面](readme-img/聊天界面.jpg =0.5x)
#### 用户对话设置
![对话详情](readme-img/对话详情.jpg =0.5x)
...
![http与websocket](readme-img/http与websocket.png =0.5x)
#### 消息类型
